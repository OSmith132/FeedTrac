...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2024 at 12:27 AM
...
--
ALTER TABLE `comment_user_rating`
  ADD CONSTRAINT `Rating_Comment` FOREIGN KEY (`commentID`) REFERENCES `comment` (`commentID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Rating_User_Comment` FOREIGN KEY (`userID`) REFERENCES `user` (`userID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `feedback`
  ADD CONSTRAINT `Feedback_Room` FOREIGN KEY (`roomID`) REFERENCES `room` (`roomID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `feedback_user_rating`
  ADD CONSTRAINT `Rating_Feedback` FOREIGN KEY (`feedbackID`) REFERENCES `feedback` (`feedbackID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Rating_User_Feedback` FOREIGN KEY (`userID`) REFERENCES `user` (`userID`) ON DELETE CASCADE ON UPDATE CASCADE;
